...
let initWebRoutes = (app) => {
  ...
  router.post(`/api/create-infor-doctors`, doctorController.createInforDoctor);
  router.get(
  ...
  router.post(
    ...
    patientController.postPatientBookAppoinment
  );
  router.post(
    `/api/veryfi-book-appoinment`,
